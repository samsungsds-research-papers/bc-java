...
public class JceTlsX25519KyberDomain implements TlsPQCDomain
{
    protected final JceTlsKyberDomain kyberDomain;
    protected final JceX25519Domain x25519Domain;
    protected final JcaTlsCrypto crypto;

    public JceTlsX25519KyberDomain(JcaTlsCrypto crypto, TlsPQCConfig pqcConfig)
    {
    ...
    {
        return new JceTlsX25519Kyber(this);
    }
